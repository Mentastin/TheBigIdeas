...
\newcommand\aset[1]{\mathrel{\overline{#1}}}
...
\DeclareMathOperator\downsets{\mathcal{O}}
...
\newcommand{\abspair}[1]{|\!\left\langle #1 \right\rangle\!|}
\DeclareMathSymbol\pol{\mathrel}{operators}{`0}
