...
\newcommand\mat[1]{\left\langle #1 \right\rangle}
...
\DeclareMathOperator\ReflRel{ReflRel}
\DeclareMathOperator\SymmRel{SymmRel}
\DeclareMathOperator\TransRel{TransRel}
\DeclareMathOperator\TolRel{TolRel}
\DeclareMathOperator\PreOrdRel{PreOrdRel}
\DeclareMathOperator\QuasiEquivRel{QuasiEquivRel}
\DeclareMathOperator\EquivRel{EquivRel}
...
\DeclareMathOperator\completion{C}
...
\newcommand\blank{\mathord{\underline{\hspace{.6em}}}}
\newcommand\fmap{\mathtt{fmap}}
\newcommand\pure{\mathtt{pure}}
\newcommand\Aseq{\mathtt{seq}}
...
\DeclareMathOperator\neighbourhoods{\mathcal{N}}
\DeclareMathOperator\vicinities{\mathcal{V}}
...
\DeclareMathOperator\pavedMod{M}
...
\DeclareMathOperator\entourage{E}
\DeclareMathOperator\entourages{\mathcal{E}}
...
\DeclareMathOperator\dualitySet{\mathfrak{d}}

\DeclareMathOperator\holomorphic{Hol}
\DeclareMathOperator\meromorphic{Mer}
...
\newcommand\constOn{\mathrel{\mathrm{constOn}}}
...
\newcommand{\comm}{\mathrel{\raisebox{0.6ex}{\scalebox{1.3}{,}}}}
%\newcommand\comm{\triangle}
\newcommand\bicomm[1]{{#1}\raisebox{-0.15em}{$\scaleobj{1.3}{\mrq}\scaleobj{1.3}{\mrq}$}}
