...
\begin{proposition}
Let $H_1, H_2$ be Hilbert spaces, then the adjoint map $*: \Bounded(H_1, H_2) \to \Bounded(H_2, H_1)$ is continuous in the norm and weak operator topologies.
\end{proposition}
\begin{proof}
Continuity in norm is follows from the fact that the adjoint map is isometric \ref{adjointMapIsometric}.
