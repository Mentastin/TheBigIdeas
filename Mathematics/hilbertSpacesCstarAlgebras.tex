...
Let $A$ be a $*$-algebra and $\mathfrak{q}$ a ranslation invariant binary relation on $A$. Then $\mathfrak{q}$ is a $\{*\}$-congruence \textup{if and only if} $\widetilde{\mathfrak{q}}^* = \widetilde{\mathfrak{q}}$.
\end{lemma}
\begin{proof}
