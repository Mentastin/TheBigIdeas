...
\[ \norm{a}_{A^{n\times n}} \defeq \sup\setbuilder{\norm{a\vec{x}}_{A^n}}{\vec{x}\in A^n, \norm{\vec{x}}_{A^n}\leq 1}. \]
\[ \norm{\begin{pmatrix}
a_{1, 1} & \hdots & a_{1,n} \\
\vdots & \ddots & \vdots \\
a_{n,1} & \hdots & a_{n,n}
\end{pmatrix}}_{A^{n\times n}} \defeq \sup\setbuilder{\max_{1 \leq i \leq n}\norm{\sum_{j=1}^na_{i,j}x_{j}}_A}{\forall 1\leq k \leq n: \big(x_k\in A\big) \land \big(\norm{x_k}_A\leq 1\big)}. \]
\[ \norm{\begin{pmatrix}
a_{1, 1} & \hdots & a_{1,n} \\
\vdots & \ddots & \vdots \\
a_{n,1} & \hdots & a_{n,n}
\end{pmatrix}}_{A^{n\times n}} \defeq \sup\setbuilder{\sqrt{\sum_{i=1}^n\norm{\sum_{j=1}^na_{i,j}x_{j}}_A^2}}{\forall 1\leq k \leq n: \big(x_k\in A\big) \land \big(\norm{x_k}_A\leq 1\big)}. \]
\end{proposition}
\begin{proof}
