...
Let $\sSet{X,d}$ be a pseudometric space and $A\subseteq X$. Then the subspace uniformity on $A$ is the same as the metric uniformity on $A$ induced by $d|_{A\times A}$.
\end{lemma}
\begin{proof}
