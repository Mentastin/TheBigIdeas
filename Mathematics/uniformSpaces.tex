...
\begin{lemma}
Let $\sSet{X,\xi}$ be a convergence space, $\sSet{Y, \mathcal{V}}$ a uniform space, $H \subseteq (X\to Y)$ and $f\in \cont(X, Y)$. If $H$ is equicontinuous, then
\begin{enumerate}
...
\begin{proposition}
TODO: If Hausdorff and regular (?), then compactiod implies relatively compact??
\end{proposition}
