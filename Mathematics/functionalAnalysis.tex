...
\item Let $\sSet{V,\xi}$ be a Hausdorff locally convex convergence vector space. Then $\sSet{\dual{V}, V, \pair{\cdot,\cdot}}$ is a dual pair by \ref{locallyConvexDualPair}.
\end{itemize}
\end{example}
