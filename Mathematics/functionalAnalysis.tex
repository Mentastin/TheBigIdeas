...
The function $\F \to \Span\{v\}: \lambda \mapsto \lambda\cdot v$ is a homeomorphism iff $\Span\{v\}$ has the final convergence w.r.t. this function. With this convergence, $\Span\{v\}$ is Hausdorff, locally compact and Choquet.

Clearly, if $\F \to \Span\{v\}: \lambda \mapsto \lambda\cdot v$ is a homeomorphism, then $\Span\{v\}$ is Hausdorff.

Now assume it is not a homeomorphism. Then the convergence on $\Span\{v\}$ is strictly weaker than the final convergence w.r.t. $\F \to \Span\{v\}: \lambda \mapsto \lambda\cdot v$, which is Hausdorff, locally compact and Choquet. The convergence on $\Span\{v\}$ is not Hausdorff by \ref{maximalHausdroffMinimalCompactChoquet}.
\end{proof}
