...
\begin{proposition} \label{lemma:commutingProjectors}
...
\begin{proposition} \label{prop:perpendicularProjections} \label{prop:subspaceProjections}
...
\begin{lemma} \label{lemma:projDerivProj}
Let $P$ be an orthogonal projector that has a derivative. Then $PP'P = 0$.
\end{lemma}
\begin{proof}
From $P' = (P^2)' = P'P + PP'$, we get $P'P = P'P + PP'P$.
\end{proof}
...
\begin{proposition}[Finite rank singular value decomposition] \label{lemma:finiteRankSingularValues}
