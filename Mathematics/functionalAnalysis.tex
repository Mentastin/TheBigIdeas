...
\end{proof}
\begin{corollary}[Hellinger-Toeplitz]
...
\begin{proof}
$(1) \Rightarrow (2)$ From \ref{symmetricOperatorAdjointInclusion}, we have $A\subseteq A^*$ and thus $A+z\id = (A^* + z\id)\cap(A+z\id)$. From point (1) of \ref{equalityAlgebraicPropertiesAdjoint}, we have $A+z\id = (A+\overline{z}\id)^*\cap (A+z\id)$.
