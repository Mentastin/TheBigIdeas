...
\begin{lemma}
Let $V$ be a TVS and $W$ a normed space. A function $f: V\to W$ is continuous \textup{if and only if} there exists a neighbourhood $U\in \neighbourhoods_V(0)$ such that $f$ is bounded on $U$.
\end{lemma}
\begin{proof}
...
\begin{proposition}
Let $V$ be a TVS. A linear functional $f:V\to \F$ on $V$ is continuous \textup{if and only if} its kernel is closed.
\end{proposition}
\begin{proof}
TODO
\end{proof}
