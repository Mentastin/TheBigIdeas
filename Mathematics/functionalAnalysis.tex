...
\begin{enumerate}
\item $\vicinity_\mathfrak{a}(0) = \upset \setbuilder{\bigcup_{v\in V} \Gamma_v\cdot V}{\forall v\in V:\; \Gamma_v \in \vicinity_\F(0)}$;
\item $\inh_\mathfrak{a}(A) = \setbuilder{x\in A}{\forall v\in V:\exists \Gamma_v \in \vicinity_\F(0):\; x + \Gamma_v\cdot v \subseteq A}$;
\item $\adh_\mathfrak{a}(A) = $
\end{enumerate}
\end{lemma}
\begin{proof}
(1) We have $\vicinity_\mathfrak{a}(0) = \bigcap_{v\in V} \upset \vicinity_\F(0)\cdot v$. Then $B\in \vicinity_\mathfrak{a}(0)$ iff for all $v\in V$ there exists a $\Gamma_v\in \vicinity_\F(0)$ such that $\Gamma_v \cdot v \subseteq B$. This is equivalent with (1).
...
\item if $A$ is convex, then $\inh_\mathfrak{a}^2(A) = \inh_\mathfrak{a}(A)$.
\end{enumerate}
\end{proposition}
\begin{proof}
TODO
...
$(1) \Rightarrow (3)$ Because $\ker(f) = f^{\preimf}(\{0\})$, it is closed by \ref{continuity}.
