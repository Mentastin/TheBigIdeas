...
\end{proposition}
\begin{proof}
(1) Take $|\lambda|\leq 1$ and $v\in \adh_\xi(A)$, then we need to show that $\lambda v \in \adh_\xi(A)$. We have $A\in \vicinity_\xi(v)^{\mesh}$ and $A\subseteq \lambda^{-1}A$. So for all $B\in \vicinity_\xi(v)$:
...
\subsection{Locally convex convergence}
\begin{definition}
...
\subsubsection{Seminorms and gauges}
