...
\begin{proposition}
Let $Z_1$ be a $\mathrm{Z}$-system, $Z_2$ a hereditary $\mathrm{Z}$-system, $P$ a poset and $M$ a $Z_1$-continuous intersection system on $P$. Then the $Z_1$-continuous $Z_2$-completion $d: P \to \Closure_{Z_2}\big(\im(d)\big): x\mapsto \downset\{x\}$ satisfies the following property:
