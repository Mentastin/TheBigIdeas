...
\item we write $D\perp E$ if $D \subseteq E^\perp$ (or equivalently $E\subseteq D^\perp$);
\item we write $D\mesh E$ if $D \subseteq E^{\mesh}$ (or equivalently $E\subseteq D^{\mesh}$).
\end{itemize}
\end{definition}

\begin{lemma}
$D\mesh E$ iff $\upset D \mesh E$.
\end{lemma}
...
\item $\forall x\in S: x\in F \iff F\mesh \upset\{x\}$;
\item $F$ is proper and $\forall x\in S: F\mesh \upset\{x\} \implies x\in F$.
\end{enumerate}
\end{proposition}
\begin{proof}
TODO
...
\[ F\vee \upset\{a\} \mesh \upset\{b\} \qquad\iff\qquad F\mesh\upset\{a\wedge b\} \]
\end{proposition}
\begin{proof}
TODO
\end{proof}
...
\begin{align*}
\text{$F\vee \upset\{a\}$ is an ultrafilter} &\iff \forall x\in S: \big( x\in F\vee \upset\{a\} \iff (F\vee \upset\{a\})\mesh \upset\{x\} \big) \\
&\iff \forall x\in S: \big( x\in F\vee \upset\{a\} \iff F\mesh \upset\{a\wedge x\} \big) \\
&\iff \forall x\in S: \big( (x\wedge a)\in F\vee \upset\{a\} \iff F\mesh \upset\{a\wedge x\} \big) \\
&\iff \forall x\in S\wedge a: \big( x\in F\vee \upset\{a\} \iff F\mesh \upset\{x\} \big) \\
&\iff \forall x\in \downset\{a\}: \big( x\in F|_a \iff F|_a\mesh \upset\{x\} \big) \\
