...
\subsubsection{Subset-stable $\mathrm{Z}$-systems}
\begin{definition}
Let $Z$ be a $\mathrm{Z}$-system. Then $Z$ is called \udef{subset-stable} if $Z(Q) = Z(P)\cap \powerset(Q)$ for all posets $P$ and all subposets $Q\subseteq P$.
\end{definition}

This is a new definition. In the literature the notion of hereditary $Z$-system is more often used. Unfortunately this excludes all $\mathrm{Z}$-systems based on cardinality and the system of $\sigma$-chains is very important for integration.

\begin{lemma} \label{nonTrivialDirectionSubsetStableZSystems}
Let $Z$ be a $\mathrm{Z}$-system. The $Z$ is subset-stable \textup{if and only if} $Z(Q) \supseteq Z(P)\cap \powerset(Q)$ for all posets $P \supseteq Q$.
\end{lemma}
\begin{proof}
...
Let $Z$ be a hereditary $\mathrm{Z}$-system, the $Z$ is subset-stable.
\end{lemma}
\begin{proof}
Take arbitrary posets $P\supseteq Q$.
We just need to prove $Z(Q) \supseteq Z(P) \cap \powerset(Q)$ by \ref{nonTrivialDirectionSubsetStableZSystems}.
...
Let $Z$ be a subset-stable $\mathrm{Z}$-system, $P$ a poset and $M$ an intersection system on $P$. Let $f: \sSet{P, \Closure_M}\to \sSet{L, (-)^{\leq\geq}}$ be a closure-continuous function to a $Z$-complete poset $L$. Take $\mathcal{D} \in Z(M)$ such that $\mathcal{D} \subseteq \setbuilder{A\in M}{\text{$A$ is $(Z,M)$-tapered}}$. Then 
\begin{enumerate}
...
Let $Z$ be a subset-stable $\mathrm{Z}$-system, $P$ a poset and $M$ a $Z$-continuous intersection system on $P$. Then the set $\setbuilder{A\in M}{\text{$A$ is $(Z,M)$-tapered}}$ is a $Z$-closed subset of $M$.
\end{corollary}
\begin{proof}
...
Let $Z_1$ be a $\mathrm{Z}$-system, $Z_2$ a subset-stable $\mathrm{Z}$-system, $P$ a poset and $M$ a $Z_1$-continuous intersection system on $P$. Then the $Z_1$-continuous $Z_2$-completion $d|^{\Closure_{Z_2}\big(\im(d)\big)}: P \to M: x\mapsto \downset\{x\}$ satisfies the following property:
...
Let $\mathcal{D} \subseteq S$ such that $\mathcal{D} \in Z_2(M)$. Since $Z_2$ is subset-stable, we have $\mathcal{D} \in Z_2\big(\Closure_{Z_2}(\im(d))\big)$. Then, since each $D\in\mathcal{D}$ is an element of $S$,
...
Let $Z$ be a subset-stable $\mathrm{Z}$-system and $P$ a poset. Then the $Z$-continuous $Z$-completion $d|^{\Closure_{Z}\big(\im(d)\big)}: P \to \mathcal{C}_{\downarrow Z}(P): x\mapsto \downset\{x\}$ satisfies the following property:
...
Let $Z$ be a subset-stable $\mathrm{Z}$-system, $P$ a $Z$-complete poset and $Q \subseteq P$ a subposet such that $\incl_Q$ is $Z$-continuous. Then $\Closure_{\downarrow Z, P}(A) = \downset \{\bigvee_P A\}$ for all $A\in \Closure_Z\big(\im(d)\big) \subseteq \mathcal{C}_{\downarrow Z}(Q)$.
\end{lemma}
\begin{proof}
...
Let $Z$ be a subset-stable $\mathrm{Z}$-system, $P$ a $Z$-complete poset and $Q \subseteq P$ a $Z$-stable subposet. Then
...
\begin{proposition}
Let $Z$ be a subset-stable $\mathrm{Z}$-system, $P,L$ $Z$-complete posets and $Q \subseteq P$ a subposet such that $\incl_Q: Q\to P$ is $Z$-continuous and $Q$ a $Z$-complete poset. Let $f: Q\to L$ be an isotone $Z$-continuous function. Then there exists a unique $Z$-continuous function $\tilde{f}: \Closure_Z(Q) \to L$ such that
\[ \begin{tikzcd}
...
\begin{proof}
This is immediate from \ref{ZcontinuousExtensionZcontinuousFunction} and \ref{ZclosureSimilarToIntersectionSystem}.
\end{proof}
