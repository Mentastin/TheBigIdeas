...
Finally we show $f,g$ are generalised inverses. We immediately have $f;g;f \subseteq \;\leq_P; f \subseteq f;\leq_Q$ and $f;g;f \subseteq f;\leq_Q^\transp$. So for all $x\in P$ we have $(f;g;f)(x) \leq_Q f(x)$ and $(f;g;f)(x) \geq_Q f(X)$, meaning $(f;g;f)(x) = (f\circ g\circ f)(x) = f(x)$.
