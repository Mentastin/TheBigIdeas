...
\begin{proposition}[Cancellation law for distributive lattices] \label{prop:cancellationDistributiveLattices}
...
\begin{lemma} \label{lemma:disjointComplementIdeal}
...
\begin{proposition}[Infinite distributive laws]
