...
\begin{lemma} \label{compositionCompatibleFunctions}
...
\[ \boldsymbol{T}\Big( \bigcup_{i\in I}f^{\preimf\imf}(\mathcal{Z}_i). \Big) \]
\end{proposition}
\begin{corollary}
...
\end{corollary}
\begin{proof}
\ref{compositionCompatibleFunctions}
\end{proof}

\begin{corollary}[Characteristic property of initial and final $\boldsymbol{T}$-subsetalgebra] \label{characteristicPropertyInitialFinalSubsetalgebra}
