...
\subsubsection{Null sets and completeness}
\begin{definition}
...
\subsubsection{Convergence on measure spaces}
\begin{definition}
...
\begin{definition}
Define $\mathfrak{I}$ as the subset of sequences $\seq{(a_n,b_n)}$ in $(\overline{\R}\times\overline{\R})^\N$ such that $b_{n-1}< a_n < b_n < a_{n+1}$.
