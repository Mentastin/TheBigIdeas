...
\end{proof}
\begin{corollary}
Suppose $f$ is holomorphic in an open set $\Omega$. If $D$ is a
disc centered at $z_0$ and whose closure is contained in $\Omega$, then $f$ has a power series expansion at $z_0$
...
\end{proof}
\begin{corollary}
Fundamental theorem of algebra (TODO)
\end{corollary}
