...
\begin{proposition}
Let $A$ be a normed algebra and $a,b\in A$ elements that have derivatives.. Then
\[ (ab)' = a'b + b'a. \]
\end{proposition}
\begin{proof}
TODO
...
\begin{proposition} \label{prop:derivativeIdempotent}
...
(3) Take derivative of (1).

(4) Multiply (3) by $p$ on the left and right.
\end{proof}
