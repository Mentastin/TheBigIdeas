...
\end{proposition}
\begin{proof}
Let $\nu$ be a regular outer measure and $\seq{A_n}_{n\in\N}$ a monotonically growing sequence of sets. Then we can find a sequence $\seq{B_n}$ such that $\nu(A_n) = \nu(B_n)$ for all $n\in\N$. 
\end{proof}
