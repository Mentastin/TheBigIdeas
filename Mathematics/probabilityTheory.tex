...
\section{Random variables, random vectors and random elements}
\begin{definition}
...
\subsection{Equivalence relations on random vectors}
\subsubsection{Almost sure equivalence}
\begin{definition}
...
\subsubsection{Equivalence in distribution}
\begin{definition}
