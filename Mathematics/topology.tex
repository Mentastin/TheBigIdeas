...
\begin{definition}
The weakest convergence compatible with the weak order is called the \udef{order convergence}, denoted $\mathfrak{o}$.
\end{definition}
...
\item the pseudometric uniformity correspond to the group uniformity.
\end{enumerate} 
\end{proposition}
\begin{proof}
