...
$(3) \Rightarrow (4) \Rightarrow (5)$ Clear.

$(5) \Rightarrow (6)$ From $F\to x$ and $F\to y$, we get $F\in \lim_\xi^{-1}(x)$ and $F\in \lim_\xi^{-1}(y)$, so $\lim_\xi^{-1}(x)\amesh \lim_\xi^{-1}(y)$. Using (3) this implies $\lim_\xi^{-1}(x) = \lim_\xi^{-1}(y)$.
...
\item $\mathcal{U}$ is symmetric and transitive.
\end{itemize}
...
\begin{definition}
Let $\sSet{X,\mathcal{U}}$ be a uniform space. Then \udef{uniform convergence} on $X$ is defined by
\[ F \overset{u}{\longrightarrow} x \qquad\defequiv\qquad F\mathrel{\mathcal{U}}\pfilter{x}. \]
\end{definition}

\subsection{Induced Cauchy convergence}
...
\[ H_1\,\mathcal{U}_c\, H_2 \qquad \defequiv \qquad \forall x\in X: \forall F\in {\lim}_\xi^{-1}(x): \; \evalMap^{\imf\imf}(H_1\otimes F) \,\mathcal{U}\, \evalMap^{\imf\imf}(H_2\otimes F). \]
\end{definition}
...
\end{lemma}
\begin{proof}
Let $\sSet{X,\xi}$ be a convergence space and $\sSet{Y,\mathcal{U}}$ a uniform space.
\end{proof}
