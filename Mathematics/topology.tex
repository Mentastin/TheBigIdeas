...
\end{lemma}
\begin{proof}
We need to show that $\{V_\epsilon\}_{\epsilon>0}$ is a filter base, that $\upset\{V_\epsilon\}_{\epsilon>0}$ is an element of $\mathcal{U}_d$ and that $\{V_\epsilon\}_{\epsilon>0}\subseteq H$ for all $H\in \mathcal{U}_d$.

That $\{V_\epsilon\}_{\epsilon>0}$ is a filter base is immediate from $V_\epsilon \cap V_\delta = V_{\min(\epsilon, \delta)}$.
