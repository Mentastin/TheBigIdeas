...
and
\[ F;G \defeq \upset \setbuilder{A;B}{A\in F, B\in G,\; A;B\neq \emptyset}. \]
\end{definition}
...
For the opposite inclusion, write
\[ \entourage = \bigcap \mathcal{U} \subseteq \bigcap \setbuilder{H;H \cap H^\transp ;H \cap H;H^\transp \cap H^\transp;H^\transp}{H\in\mathcal{U}}. \]
Now take $A\in \entourage$. Then for all $H\in\mathcal{U}$, there exist $B_H, C_H\in H$ such that $B_H;C_H \subseteq A$. Now consider
\[ D_H \defeq B_H\cap B_H^\transp \cap C_H \cap C_H^\transp. \]
...
\[ H\in \mathcal{U} \quad\implies\quad f^{\imf\imf}[H]\in \mathcal{V}. \]
\end{definition}
