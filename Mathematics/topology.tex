...
\[ \mathcal{U}_\mathcal{S} \defeq \setbuilder{H\in \powerfilters\big((X\to Y)^2\big)}{\forall S\in \mathcal{S}:\; (\evalMap\times \evalMap)^{\imf\imf}(H\otimes \{\Delta_S\})^\ttransp \in \mathcal{U}} \]
