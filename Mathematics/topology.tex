...
\begin{definition}
Let $f: X\to Y$ be a map between metric spaces, then $f$ is called \udef{Lipschitz continuous} if there exists a constant $M$ such that
\[ d_Y(f(x), f(y)) \leq M d_X(x,y) \qquad \forall x,y\in X. \]
The constant $M$ is called the \udef{Lipschitz contstant}.
\end{definition}
