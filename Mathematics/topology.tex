...
\begin{definition}
Let $\sSet{X,\xi}, \sSet{Y,\zeta}$ be convergence spaces and $f:X\to Y$ a function. Then $f$ is called \udef{sequentially continuous} if $f: \sSet{X, \seqMod(\xi)} \to \sSet{Y, \zeta}$ is continuous.
\end{definition}
