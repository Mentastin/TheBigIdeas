...
\end{proposition}
\begin{proof}
$(1)$ Assume $A,B$ are separated by vicinities $U$ and $V$. Assume, towards a contradiction, that $F(A)\amesh F(B)$ for some approach $F$. Then for all $a\in A$, $U\in F(a)$, so $U\in F(A)$. Similarly $V\in F(B)$. This means $U\mesh V$, which is a contradiction.
...
$(4) \Rightarrow (5)$ From $F\to x$ and $F\to y$, we get $F\in \lim_\xi^{-1}(x)$ and $F\in \lim_\xi^{-1}(y)$, so $\lim_\xi^{-1}(x)\amesh \lim_\xi^{-1}(y)$. Using (3) this implies $\lim_\xi^{-1}(x) = \lim_\xi^{-1}(y)$.
...
\iff& \forall x\in X: \forall V\in \vicinity_\xi(x): \exists U \in \vicinity_\xi(x): \quad \neg(\{U\} \amesh \vicinity_\xi(V^c)) \\
\iff& \forall x\in X: \forall V\in \vicinity_\xi(x): \quad \neg(\forall U \in \vicinity_\xi(x):\{U\} \amesh \vicinity_\xi(V^c)) \\
\iff& \forall x\in X: \forall V\in \vicinity_\xi(x): \quad \neg(\vicinity_\xi(x) \amesh \vicinity_\xi(V^c)).
\end{align*}
