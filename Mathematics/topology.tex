...
\[ p_1^{\imf\imf}(H)\otimes p_2^{\imf\imf}(H) = p_1^{\imf\imf}(H)\otimes p_1^{\imf\imf}(H); H; p_2^{\imf\imf}(H)\otimes p_2^{\imf\imf}(H). \]
\end{lemma}
\begin{proof}
The inclusion $\supseteq$ follows from \ref{componentInclusionsFilterComposition}.
...
A uniformity is called \udef{factorisible} if for all $H\in\mathcal{U}$, there exist $F,G\in \powerfilters(X^2)$ such that $F\otimes G \in\mathcal{U}$ and $F\otimes G\subseteq H$.
\end{definition}
