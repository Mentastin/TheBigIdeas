...
\begin{proposition}
Let $X$ be a set and $F\in\powerfilters(X)$.
...
$\boxed{\Leftarrow}$ Assume $F$ contains a countable set $A$ and consider some enumeration (i.e. surjective function) $f:\N\to\mathcal{B}$.
