...
\begin{proposition}
Let $\sSet{X,\mathcal{U}}$ be a uniform space. Then the following are equivalent:
\begin{enumerate}
\item $\mathcal{U}$ is Choquet;
\item $\forall H\in\powerfilters(X^2):$ $H \in \mathcal{U}$ iff each ultrafilter $H'\supseteq H$ is in $\mathcal{U}$.
\end{enumerate}
\end{proposition}
\begin{proof}
TODO
...
\begin{proposition}
Let $\sSet{X,\mathcal{U}}$ be a compact uniform space. If $H$ is an ultrafilter in $\mathcal{U}$, then $p_1^{\imf\imf}[H]\otimes p_2^{\imf\imf}[H] \in\mathcal{U}$.
\end{proposition}
\begin{proof}
...
\begin{enumerate}
\item if $\mathcal{U}$ is compact and $f: \sSet{X,\Gamma(\Xi(\mathcal{U}))} \to \sSet{Y,\Gamma(\Xi(\mathcal{V}))}$ is continuous, then $f: \sSet{X,\mathcal{U}} \to \sSet{Y,\mathcal{V}}$ is uniformly continuous.
\end{enumerate}
\end{proposition}
\begin{proof}
