...
A filter $H\in \powerfilters(X\to Y)$ converges in the \udef{continuous convergence} on $(X\to Y)$ to $f\in (X\to Y)$ if
\[ \forall F\overset{\xi}{\longrightarrow} x: \; \evalMap(H \otimes F) \overset{\zeta}{\longrightarrow} f(x). \]
