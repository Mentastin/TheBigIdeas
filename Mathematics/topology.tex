...
\begin{proposition}
Let $\xi$ be a convergence on a set $X$. Then $\xi$ is a pretopological convergence \textup{if and only if} $\lim_\xi: \filters(\powerset(X))\to \powerset(X)$ is a meet-semilattice homomorphism, i.e.
