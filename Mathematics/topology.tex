...
Let $\sSet{P,\leq}$ be a poset, $\xi$ a convergence compatible with the weak order and $x\in P$. Then $\upset\{x\}$ and $\downset\{x\}$ are closed.
\end{proposition}
\begin{proof}
...
The argument for $\downset\{x\}$ is dual.
\end{proof}
