...
\end{proposition}
\begin{proof}
By \ref{singletonAdherence} we have $\adh_\xi(\{x\}) = \lim_\xi\upset\{x\}$ and $\adh_\xi(\{y\}) = \lim_\xi\upset\{y\}$.
\end{proof}
...
\end{lemma}
\begin{proof}
Assume $x,y$ separated. WLOG we can assume $\upset\{x\} \not\to y$. So $\upset\{x\}$ distinguishes $x$ and $y$.
\end{proof}
...
\item for all $x,y\in X$, $x$ and $y$ are indistinguishable \textup{if and only if} $\upset\{x\} \to y$;
...
\item for all $x,y\in X$:  $\upset\{x\} \to y$ \textup{if and only if} $\upset\{y\} \to x$;
\end{enumerate}
\end{proposition}
\begin{proof}
...
$(2) \Rightarrow (3)$ All points that are indistinguishable from $x$ are in $\adh_\xi(\{x\}) = \lim_\xi\{x\}$ by construction. Assume $y$ is distinguishable from $x$. Then $y$ is separated from $x$, so $\upset\{x\}\not\to x$ by \ref{separatednessPrincipalUltrafilters}.

$(3) \Rightarrow (4)$ $\adh_\xi(\{x\}) = \lim_\xi\upset\{x\}$ by \ref{singletonAdherence}.

$(4) \Rightarrow (1)$ Assume $x,y\in X$ are distinguishable. Then $y\notin\adh_\xi(\{x\})$ and $x\notin\adh_\xi(\{y\})$. This means $\upset\{x\} \not\to y$ and $\upset\{y\} \not\to x$ and we conclude by \ref{separatednessPrincipalUltrafilters}.
...
\item $\forall x\in X: \; \adh_\xi(\{x\}) = \{x\}$;
