...
\begin{definition}
A (pre)convergence $\xi$ is called \udef{finitely deep} if 
...
\begin{definition}
A convergence space $\sSet{X,\xi}$ is called \udef{regular} if
...
$(2) \Rightarrow (3)$ Indistinguishability is an equivalence relation.

$(3) \Rightarrow (4)$  TODO requires topological assumption?
...
\[ \sSet{X \cup \powerset(X) \cup \powerset(\powerset(X)), \overset{\xi}{\longrightarrow}} \to \sSet{Y \cup \powerset(Y) \cup \powerset(\powerset(Y)), \overset{\zeta}{\longrightarrow}}. \]
