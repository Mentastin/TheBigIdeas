...
\subsubsection{Compactoid vs. relatively compact}

\begin{proposition}
Let $\sSet{X,\xi}, \sSet{Y,\zeta}$ be convergence spaces. If $H$ is compactoid in $\cont_c(X, Y)$ and $\evalMap_x^\imf(H)$ relatively compact for all $x\in X$, then $H$ is relatively compact in $\cont_c(X, Y)$.
\end{proposition}
\begin{proof}
