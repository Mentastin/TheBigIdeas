...
Note that $\powerset(X)\cancel\amesh\powerset(X)$. So $\big(F\otimes \powerset(X)\big);\big(\powerset(X)\otimes G\big) = \powerset(X^2)$, independent of $F$ and $G$.
...
\[ H\in \mathcal{U} \quad\implies\quad \upset (f\times f)^{\imf\imf}[H]\in \mathcal{V}. \]
\end{definition}
...
\[ \entourage_\mathcal{V} \subseteq \bigcap\setbuilder{\upset (f\times f)^{\imf\imf}[H]}{H\in \mathcal{U}} = \upset (f\times f)^{\imf\imf}\left[\bigcap \mathcal{U}\right] = \upset (f\times f)^{\imf\imf}\left[\entourage_\mathcal{U}\right]. \]
The first equality follows from \ref{imageFiltersPreservesIntersection}.

(2) Assume $\entourage_\mathcal{V} \subseteq \upset (f\times f)^{\imf\imf}[\entourage_\mathcal{U}]$ and take $H\in \mathcal{U}$. Then $\entourage_\mathcal{U}\subseteq H$, so
\[ \entourage_\mathcal{V} \subseteq \upset (f\times f)^{\imf\imf}[\entourage_\mathcal{U}] \subseteq \upset (f\times f)^{\imf\imf}[H]. \]
Thus $\upset (f\times f)^{\imf\imf}[H] \in\mathcal{V}$.
\end{proof}
...
\begin{lemma} \label{uniformityRelationRelatedElementLemma}
...
\begin{lemma} \label{uniformityRelationUpwardsClosure}
...
\item If $H\in\Theta(R)$ and $H\subseteq H'$, then $p_1^{\imf\imf}[H]\mathrel{R} p_2^{\imf\imf}[H]$, $p_1^{\imf\imf}[H]\subseteq p_1^{\imf\imf}[H']$ and $p_2^{\imf\imf}[H]\subseteq p_2^{\imf\imf}[H']$. Thus, by \ref{uniformityRelationUpwardsClosure}, we have $p_1^{\imf\imf}[H']\mathrel{R} p_2^{\imf\imf}[H']$ and so $H'\in\Theta(R)$.
...
\item Take $H_1, H_2\in \Theta(R)$. If $H_1;H_2 = \powerset(X^2)$, then $H_1;H_2\in\Theta(R)$ by upwards closure. If $H_1;H_2 \neq \powerset(X^2)$, then $p_2^{\imf\imf}[H_1]\amesh p_1^{\imf\imf}[H_2]$ by \ref{meshingFilterComposition} and thus $p_2^{\imf\imf}[H_1]\mathrel{R} p_1^{\imf\imf}[H_2]$ by \ref{uniformityRelationRelatedElementLemma} (we have that $p_1^{\imf\imf}[H_1]\mathrel{R}p_2^{\imf\imf}[H_1]$, so $p_1^{\imf\imf}[H_1]\mathrel{R}\neq \emptyset$. Similarly $p_1^{\imf\imf}[H_2]\mathrel{R}p_2^{\imf\imf}[H_2]$ and $p_1^{\imf\imf}[H_2]\mathrel{R}\neq \emptyset$). So we have
...
\[ F \overset{\Gamma(\mathcal{U})}{\longrightarrow} x \qquad\defequiv\qquad F\otimes\pfilter{x}\in\mathcal{U}. \]
We also denote the uniform convergence by $F\overset{u}{\longrightarrow} x$.
\end{definition}
Note that the uniform convergence is a really a property of the associated uniform relation. If $\mathcal{U}_1, \mathcal{U}_2$ are uniform structures such that $\Xi(\mathcal{U}_1) = \Xi(\mathcal{U}_2)$, then $\Gamma(\mathcal{U}_1) = \Gamma(\mathcal{U}_2)$.
...
\end{lemma}
\begin{proof}
We immediately have $\pfilter{x}\in\mathcal{F}$ for all $x\in X$ because $\pfilter{x}\otimes \pfilter{x} \in \mathcal{U}$.
...
\subsection{Induced uniform space}
\begin{definition}
