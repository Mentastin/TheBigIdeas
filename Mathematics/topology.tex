...
\end{enumerate}
If $X$ is a lattice, then these are equivalent to
\begin{enumerate} \setcounter{enumi}{7}
\item $x\in \bigcap_{A\in F}A^{\leq \geq} \cap \bigcap_{A\in F}A^{\geq\leq}$;
\item $\{x\} = \bigcap_{A\in F}A^{\leq \geq} \cap \bigcap_{A\in F}A^{\geq\leq}$.
\end{enumerate}
\end{proposition}
TODO: reorganise proof!
\begin{proof}
...
\begin{example}
TODO: example to show that (7), (8) are not equivalent to the rest in general.
\end{example}
...
0 & (m= \infty = n){extendedNaturalsTopological}
\end{cases} \]
