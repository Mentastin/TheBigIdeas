...
\begin{enumerate}
\item \udef{linear} if $\pd{F}{2}{u^{(i)}}{1}{u^{(j)}}{1} \equiv 0$ for all $i,j\in [0,n]$;
...
\[ L \defeq \sum_{i=0}^n a_{i} \left(\od{}{t}\right). \]
...
\[ u' = u^2 \qquad u(0) = c. \]
The function
\[ u: \R\setminus\{\frac{1}{c}\} \to \R: t\mapsto \frac{c}{1-ct} \]
