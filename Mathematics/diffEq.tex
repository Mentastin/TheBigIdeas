...
$(2) \Rightarrow (3)$ Take arbitrary $t_0\in\R^{\geq 0}$. Take some $r>0$ such that $R_{A_n}(r)x\to R_{A}(r)x$ for all $x\in X$. TODO Banach-Steinhaus!
...
\section{Operator-valued semigroups}
