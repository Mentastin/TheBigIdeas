...
\begin{theorem}[Second Trotter-Kato approximation theorem]
...
\end{align*}
Now we have, using Cauchy-Schwarz (TODO?),
\begin{align*}
...
\begin{lemma}
Evolution semigroups are strongly continuous semigroups.
\end{lemma}
\begin{proof}
...
\begin{proposition}
There is a one-to-one correspondence between evolution semigroups and exponentially bounded evolution families.
\end{proposition}
