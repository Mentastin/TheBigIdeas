...
\begin{definition}
Let $X$ be a Banach space and $\sSet{I, +, 0, \leq}$ an ordered commutative monoid. We call a function $T: I \to \Lin(X)$ a \udef{semigroup of linear operators} (or just \udef{semigroup}) if
\begin{itemize}
\item $T(0) = \id_X$;
