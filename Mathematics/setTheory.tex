...
\end{lemma}
\begin{corollary}
Let $R$ be a relation, then $R \subseteq R;R^\transp;R$.
\end{corollary}
\begin{corollary}
...
\begin{proposition}[Dedekind formula]
...
using \ref{relationalComposition} for the last equivalence.
\end{proof}
\begin{corollary}
...
\end{lemma}
\begin{proof}
Immediate from \ref{relationalComposition}.
\end{proof}
