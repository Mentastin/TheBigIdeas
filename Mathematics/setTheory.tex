...
\begin{definition}
Let $\sSet{A,f}$ be an associative class and $B\subseteq A$ a subclass. The \udef{centraliser} or \udef{commutant} of $B$ is defined as
\[ Z_A(B) \defeq \setbuilder{a\in A}{\forall b\in B:\;ab = ba}. \]
In particular we define the \udef{centre} of $A$ as the centraliser of all of $A$:
\[ Z_A \defeq Z_A(A). \]
