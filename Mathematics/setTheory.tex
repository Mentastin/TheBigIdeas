...
TODO:
\url{http://karagila.org/2019/in-praise-of-replacement/}

and

\url{https://mathoverflow.net/questions/228168/what-does-the-axiom-of-replacement-mean-and-why-should-i-believe-it/228194#228194}
...
\begin{proposition}[Russell's paradox] \label{russellParadox}
...
We also call
\begin{itemize}
\item an element of $\sup(X) \defeq \min(X^R) = X^R \cap (X^R)^{R^\transp}$ a \udef{least upper bound}, \udef{supremum}, or \udef{join};
\item an element of $\inf(X) \defeq \max({^RX}) = X^{R^\transp} \cap (X^{R^\transp})^R$ a \udef{greatest lower bound}, \udef{infimum}, or \udef{meet}.
\end{itemize}
\end{definition}
...
TODO: $\bigvee$ singleton unpacking of $\sup$.
...
\begin{lemma} \label{relationConverseSimilarity}
Let $A,B$ be sets. Then $(-)^\transp: \powerset(A\times B) \to \powerset(B\times A): R\mapsto R^\transp$ is an order similarity.
\end{lemma}
...
TODO: define ``$c$'' as $\overline{\id}$. In particular complements are polars!!
...
\begin{lemma} \label{transitivityReflexiveRelationLemma}
...
\begin{lemma} \label{connexityEquivalents}
Let $R$ be a homogeneous relation on $A$. Then
\begin{enumerate}
\item $\begin{aligned}[t]
...
\end{enumerate}
\end{proposition}
We say the equivalence classes \udef{partition} $A$.
\begin{proof}
...
\begin{definition}
Let $X$ be a set and $P\subseteq \powerset(X)$. Then $P$ is called a \udef{partition} of $X$ if
\begin{itemize}
...
\subsection{Lattices of relations}
TODO: relocate
...
(3) This is immediate from (2) and \ref{imageAlgebraicClosureAlgebraicLattice}.
\end{proof}

\begin{definition}
Let $A$ be a set and $R$ a relation on $A$. Then we also write $R^?$ for $\Closure_{\ReflRel}(R)$.
\end{definition}

\subsubsection{Symmetric relations}
\begin{definition}
Let $A$ be a set. Then the set of symmetric relations on $A$, ordered by inclusion, is denoted $\SymmRel(A)$.
\end{definition}

\begin{proposition}
Let $A$ be a set. Then $\SymmRel(A)$
\begin{enumerate}
\item is a complete $\wedge$-subsemilattice of $\powerset(A^2)$;
...
\begin{definition}
Let $A$ be a set and $R$ a relation on $A$. Then we also write $R^\leftrightarrow$ for $\Closure_{\SymmRel}(R)$.
\end{definition}
...
\begin{proposition} \label{transitiveClosureProp}
Let $A$ be a set. Then $\TransRel(A)$
\begin{enumerate}
\item is a complete $\wedge$-subsemilattice of $\powerset(A^2)$;
...
\begin{definition}
Let $A$ be a set and $R$ a relation on $A$. Then we also write $R^+$ for $\Closure_{\TransRel}(R)$.
\end{definition}
...
\end{proposition}
TODO: relate this to the tree $T_R$.
\begin{proof}
Immediate from the form of the transitive closure calculated in \ref{transitiveClosureProp}.
\end{proof}
...
\begin{proof}
We have
\[ (R^+)^\transp = \Big(\bigcup_{n\geq 1}R^n\Big)^\transp = \bigcup_{n\geq 1}(R^n)^\transp = \bigcup_{n\geq 1}(R^\transp)^n = (R^\transp)^+, \]
from \ref{transitiveClosureProp} and \ref{relationConverseSimilarity}.
\end{proof}


\subsubsection{Tolerance relations}
\begin{definition}
Let $A$ be a set. Then the set of tolerance relations on $A$, ordered by inclusion, is denoted $\TolRel(A)$.
\end{definition}
Thus $\TolRel(A) = \ReflRel(A) \cap \SymmRel(A)$.


\begin{lemma} \label{reflexiveSymmetricClosuresCommute}
Let $A$ be a set. Then the closure operators into $\ReflRel$ and $\SymmRel$ commute, i.e.
\[ \Closure_{\ReflRel}\circ \Closure_{\SymmRel} = \Closure_{\SymmRel}\circ \Closure_{\ReflRel}. \]
\end{lemma}
\begin{proof}
...
\begin{proposition} \label{toleranceClosureProp}
Let $A$ be a set. Then $\TolRel(A)$
\begin{enumerate}
\item is a complete $\wedge$-subsemilattice of $\powerset(A^2)$;
\item has an algebraic closure operator
\[ \Closure_{\TolRel} = \Closure_{\ReflRel}\circ \Closure_{\SymmRel}: \powerset(A^2)\to \TolRel(A): R \mapsto R\cup R^\transp \cup \id_A; \]
\item is an algebraic lattice.
\end{enumerate}
\end{proposition}
\begin{proof}
(1) By \ref{intersectionCompleteSemilatticesCompleteSemilattice}.

(2) By \ref{reflexiveSymmetricClosuresCommute} and \ref{compositionOfAlgebraicClosuresAlgebraic}.

(3) This is immediate from (2) and \ref{imageAlgebraicClosureAlgebraicLattice}.
\end{proof}

\begin{definition}
Let $A$ be a set and $R$ a relation on $A$. Then we also write $R^{\overset{?}{\leftrightarrow}}$ for $\Closure_{\TolRel}(R)$.
\end{definition}

\subsubsection{Preorder relations}
Preorder relations are reflexive and transitive relations.
\begin{definition}
Let $A$ be a set. Then the set of preorder relations on $A$, ordered by inclusion, is denoted $\PreOrdRel(A)$.
\end{definition}

\begin{lemma} \label{reflexiveTransitiveClosuresCommute}
Let $A$ be a set. Then $\Closure_{\TransRel}$ and $\Closure_{\ReflRel}$ commute, i.e.\
\[ \Closure_{\TransRel}\circ \Closure_{\ReflRel} = \Closure_{\ReflRel}\circ \Closure_{\TransRel}. \]
\end{lemma}
\begin{proof}
Take $R\in \powerset(A^2)$. Then we calculate
\begin{align*}
\big(\Closure_{\TransRel}\circ \Closure_{\ReflRel}\big)(R) &= \bigcup_{n\geq 1}(R \cup \id_A)^n \\
&= \Big(\bigcup_{n\geq 1}R^n\Big) \cup \id_A \\
&= \big(\Closure_{\ReflRel}\circ \Closure_{\TransRel}\big)(R).
\end{align*}
\end{proof}

\begin{proposition}
Let $A$ be a set. Then $\PreOrdRel(A)$
\begin{enumerate}
\item is a complete $\wedge$-subsemilattice of $\powerset(A^2)$;
\item has an algebraic closure operator
\[ \Closure_{\PreOrdRel} = \Closure_{\ReflRel}\circ \Closure_{\TransRel}: \powerset(A^2)\to \TolRel(A): R \mapsto \bigcup_{n\geq 1}R^n \cup \id_A; \]
\item is an algebraic lattice.
\end{enumerate}
\end{proposition}
\begin{proof}
...
(2) By \ref{reflexiveTransitiveClosuresCommute} and \ref{compositionOfAlgebraicClosuresAlgebraic}.

(3) This is immediate from (2) and \ref{imageAlgebraicClosureAlgebraicLattice}.
\end{proof}

\subsubsection{Quasi-equivalence relations}
A relation is a quasi-equivalence relation if it is symmetric and transitive.
\begin{definition}
Let $A$ be a set. Then the set of quasi-equivalence relations on $A$, ordered by inclusion, is denoted $\QuasiEquivRel(A)$.
\end{definition}

\begin{lemma} \label{symmetricTransitiveClosuresCompatible}
Let $A$ be a set. Then
\[ \Closure_{\TransRel}\circ \Closure_{\SymmRel} = \Closure_{\SymmRel}\circ \Closure_{\TransRel}\circ \Closure_{\SymmRel}. \]
\end{lemma}
\begin{proof}
Take $R\in \powerset(A^2)$. Then we calculate
\begin{align*}
\big(\Closure_{\SymmRel}\circ \Closure_{\TransRel}\circ \Closure_{\SymmRel}\big)(R) &= \Big(\bigcup_{n\geq 1}(R\cup R^\transp)^n\Big) \cup \Big(\bigcup_{n\geq 1}(R\cup R^\transp)^n\Big)^\transp \\
&= \Big(\bigcup_{n\geq 1}(R\cup R^\transp)^n\Big) \cup \Big(\bigcup_{n\geq 1}(R\cup R^\transp)^n\Big) \\
&= \bigcup_{n\geq 1}(R\cup R^\transp)^n \\
&= \big(\Closure_{\TransRel}\circ \Closure_{\SymmRel}\big)(R).
\end{align*}
\end{proof}
\begin{corollary}
Let $R$ be a homogeneous relation over a class $A$. Then $\big(R^\leftrightarrow\big)^+ \supseteq \big(R^+\big)^\leftrightarrow$.
\end{corollary}
...
\begin{proposition}
Let $A$ be a set. Then $\QuasiEquivRel(A)$
\begin{enumerate}
\item is a complete $\wedge$-subsemilattice of $\powerset(A^2)$;
\item has an algebraic closure operator
\[ \Closure_{\QuasiEquivRel} = \Closure_{\TransRel}\circ \Closure_{\SymmRel}: \powerset(A^2)\to \TolRel(A): R \mapsto \bigcup_{n\geq 1}(R \cup R^\transp)^n; \]
\item is an algebraic lattice.
\end{enumerate}
\end{proposition}
\begin{proof}
...
(2) By \ref{symmetricTransitiveClosuresCompatible} and \ref{compositionOfAlgebraicClosuresAlgebraic}.
...
\begin{lemma} \label{toleranceTransitiveClosuresCompatible}
Let $A$ be a set. Then
\[ \Closure_{\TransRel}\circ \Closure_{\TolRel} = \Closure_{\TolRel}\circ \Closure_{\TransRel}\circ \Closure_{\TolRel}. \]
\end{lemma}
\begin{proof}
We calculate
\begin{align*}
\Closure_{\TransRel}\circ \Closure_{\TolRel} &= \Closure_{\TransRel}\circ \Closure_{\SymmRel} \circ \Closure_{\ReflRel} \\
&= \Closure_{\SymmRel}\circ \Closure_{\TransRel}\circ \Closure_{\SymmRel} \circ \Closure_{\ReflRel} \\
&= \Closure_{\SymmRel}\circ \Closure_{\TransRel}\circ \Closure_{\SymmRel} \circ \Closure_{\ReflRel}^2 \\
&= \Closure_{\SymmRel}\circ \Closure_{\ReflRel} \circ \Closure_{\TransRel}\circ \Closure_{\SymmRel} \circ \Closure_{\ReflRel} \\
&= \Closure_{\TolRel} \circ \Closure_{\TransRel}\circ \Closure_{\TolRel},
\end{align*}
using \ref{toleranceClosureProp}, \ref{symmetricTransitiveClosuresCompatible} and \ref{reflexiveSymmetricClosuresCommute}.
\end{proof}

\begin{proposition}
Let $A$ be a set. Then $\EquivRel(A)$
\begin{enumerate}
\item is a complete $\wedge$-subsemilattice of $\powerset(A^2)$;
\item has an algebraic closure operator $\begin{aligned}[t]\Closure_{\EquivRel} &= \Closure_{\TransRel}\circ \Closure_{\TolRel} \\
&= \Closure_{\TransRel}\circ \Closure_{\ReflRel}\circ \Closure_{\SymmRel}\end{aligned}$ given by
\[ \Closure_{\EquivRel}: \powerset(A^2) \to \EquivRel(A): R\mapsto \bigcup_{n\geq 1}(R\cup R^\transp \cup \id_A)^n; \]
\item is an algebraic lattice.
\end{enumerate}
\end{proposition}
\begin{proof}
...
(2) By \ref{toleranceTransitiveClosuresCompatible} and \ref{compositionOfAlgebraicClosuresAlgebraic}.

(3) This is immediate from (2) and \ref{imageAlgebraicClosureAlgebraicLattice}.
\end{proof}

\begin{definition}
Let $A$ be a set and $R$ a relation on $A$. Then we also write $R^{\overset{*}{\leftrightarrow}}$ for $\Closure_{\EquivRel}(R)$.
\end{definition}
...
\begin{itemize}
\item the \udef{post-composition function} of $f$ as $f_\star: (C\to A) \to (C\to B): g\mapsto f\circ g$.
\item the \udef{pre-composition function} of $f$ as $f^\star: (B\to C) \to (A\to C): g\mapsto g\circ f$.
\end{itemize}
...
is the \udef{inclusion} function of $A$ in $X$.
\end{definition}
...
\item a \udef{principal image function} $-R: A\to \powerset(B): x \mapsto xR$;
\item \udef{principal preimage function} is the function $R-: B\to \powerset(A): y \mapsto Ry$.
\end{itemize}
...
\begin{lemma} \label{functorialityImageFunction}
...
\begin{definition}
Let $A, B, C$ be classes and $f: A\times B \to C$ a binary function. We define the \udef{dual} function $f^d: B\times A \to C$ of $f$ as $f^d \defeq f\circ \pairSwap$. 
\end{definition}
...
We consider $\curry_1$ as a function between classes:
...
\subsubsection{Currying relations and set-valued functions}
...
\begin{definition}
Let $A,B$ be sets and $f: A\to \powerset(B)$ a set-valued function. Then the \udef{transpose} $f^\transp$ of $f$ is defined by
...
\begin{lemma} \label{transpositionSetValuedFunctionLemma}
...
\begin{definition}
Let $C, F$ be finite sets of symbols. Then \udef{language of types} $T(C, F)$ is defined by
...
\begin{definition}
Let $C, F$ be finite sets of symbols. An \udef{interpretation} of $\sSet{C, F}$ is a tuple $\sSet{I_C, I_F}$ where
\begin{itemize}
...
\begin{proposition} \label{existenceUniquenessInterpretationOfType}
...
\begin{definition}
We call a function $I: T(C,F) \to \setbuilder{x}{\Set(x)}$ as defined in \ref{existenceUniquenessInterpretationOfType} an \udef{interpretation} of $T(C,F)$.
\end{definition}
...
A \udef{typeclass signature} is a tuple $\sSet{\Omega, C, \blank,F,t}$, where $t: \Omega \to T(C\cup\{\blank\},F)$ is a function.
\end{definition}

\subsection{Semantics}
\begin{definition}
A \udef{structure} of type $\sSet{\Omega, C, \blank,F,t}$ or \udef{$\Omega$-structure} consists of
\begin{itemize}
\item a set $A$;
...
TODO convenient ways to represent signature (see Functors, Applicative, Monads).

\section{Parametric typeclasses}
\begin{definition}
Let $C,V,F, \Omega$ be disjoint sets and $\blank$ an element not in any of them.

A \udef{parametric typeclass signature} is a tuple $\sSet{\Omega, C, V, F, \blank,t}$, where $t: \Omega \to T(C\cup V,F\cup\{\blank\})$ is a function.
\end{definition}

\subsection{Semantics}
\begin{definition}
A \udef{structure} of type $\sSet{\Omega,C,V,F, \blank,t}$ or \udef{$\Omega$-structure} consists of
\begin{itemize}
...
\begin{definition}
A \udef{functor} is a parametric typeclass of type
...
We can simplify the type information by saying that a \udef{functor} is a parametric typeclass $F$ with signature
\[ \fmap: (A\to B) \to F(A) \to F(B). \]


\subsubsection{Semi-applicatives}
\begin{definition}
A \udef{semi-applicative} is a parametric typeclass $F$ with signature
\begin{align*}
&\fmap: (A\to B) \to F(A) \to F(B) \\
&\pure: A\to F(A)
\end{align*}
...
\begin{definition}
An \udef{applicative} is a parametric typeclass $F$ with signature
\begin{align*}
&\fmap: (A\to B) \to F(A) \to F(B) \\
&\pure: A\to F(A) \\
...
\begin{definition}
A \udef{monad} is a parametric typeclass $F$ with signature
\begin{align*}
&\fmap: (A\to B) \to F(A) \to F(B) \\
&\pure: A\to F(A) \\
&\join: F^2(A) \to F(A)
...
\begin{lemma} \label{increasingEnumeration}
