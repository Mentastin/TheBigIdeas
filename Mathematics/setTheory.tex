...
\begin{proposition}
Let $A$ be a class, $f: A\times A \to A$ an associative binary function and $x\in A$. Then $x$ is regular \textup{if and only if} it has a generalised inverse.
\end{proposition}
\begin{proof}
...
\begin{proposition}
Let $A$ be a class, $f: A\times A \to A$ an associative binary function and $e,f$ idempotents in $A$ such that $e\greensD f$. Then there exist $x\in [e]_\greensR\cap [f]_\greensL$ and $x'\in [e]_\greensL\cap [f]_\greensR$ such that
\begin{itemize}
...
\end{proof}
\begin{corollary}
Let $A$ be a class, $f: A\times A \to A$ an associative binary function, $y\in A$ and $e,f$ idempotents in $A$. Then $e\greensD f$ \textup{if and only if} there exist generalised inverses $x,x'$ such that $e = xx'$ and $f = x'x$.
\end{corollary}
\begin{proof}
...
\begin{lemma}
Let $A$ be a class, $f: A\times A \to A$ an associative binary function, $x\in A$. Then no $\greensH$-class contains more than one generalised inverse of $x$.
\end{lemma}
\begin{proof}
...
\begin{proposition}
Let $A$ be a class, $f: A\times A \to A$ an associative binary function and $x,y\in A$. Then $xy\in [x]_\greensR \cap [y]_\greensL$ \textup{if and only if} $[x]_\greensL \cap [y]_\greensR$ contains an idempotent.
\end{proposition}
\begin{proof}
