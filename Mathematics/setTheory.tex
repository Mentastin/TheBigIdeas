...
\begin{lemma}
Let $\sSet{A, f}$ be an associative class with identity $e$ and $x,y$ in $A$.
\begin{enumerate}
\item If $x$ has left-inverse $x^{-L}$ and $y$ has a left-inverse $y^{-L}$, then $f(x,y)$ has a left-inverse $f(y^{-L}, x^{-L})$.
\item If $x$ has right-inverse $x^{-R}$ and $y$ has a right-inverse $y^{-R}$, then $f(x,y)$ has a right-inverse $f(y^{-R}, x^{-R})$.
\item If $x$ has inverse $x^{-1}$ and $y$ has inverse $y^{-1}$, then $f(x,y)$ has inverse $f(y^{-1}, x^{-1})$.
\item If $f(x,y)$ has a left-inverse $f(x,y)^{-L}$, then $y$ has a left-inverse $f\big(f(x,y)^{-L}, x\big)$.
\item If $f(x,y)$ has a right-inverse $f(x,y)^{-R}$, then $x$ has a right-inverse $f\big(y, f(x,y)^{-R}\big)$.
\end{enumerate}
\end{lemma}
\begin{proof}
Let $z_1, z_2\in A$.
...
(1) We calculate
\[ f\big(f(y^{-L}, x^{-L}),f(x,y)\big) = f\Big(f\big(y^{-L}, f(x^{-L},x)\big), y\Big) = f\big(f(y^{-L}, e), y\big) = f(y^{-L}, y) = e. \]

(2) We calculate
\[ f\big(f(x, y),f(y^{-R},x^{-R})\big) = f\Big(f\big(x, f(y,y^{-R})\big), x^{-R}\Big) = f\big(f(x, e), x^{-R}\big) = f(x, x^{-R}) = e. \]

(3) Follows from (1) and (2).

(4) We calculate
\[ f\Big(f\big(f(x,y)^{-L}, x\big), y\Big) = f\big(f(x,y)^{-L}, f(x,y)\big) = e. \]

(5) We calculate
\[ f\Big(x, f\big(y, f(x,y)^{-R}\big)\Big) = f\big(f(x,y), f(x,y)^{-R}\big) = e. \]
\end{proof}
...
\item If $f(x,y)$ is right-cancellative, then $x$ is right-cancellative.
\end{enumerate}
\end{lemma}
\begin{proof}
Let $z_1, z_2\in A$.
