...
Take $R\in \powerset(A^2)$. Then we calculate
\begin{align*}
\big(\Closure_{\TolRel}\circ \Closure_{\TransRel}\circ \Closure_{\TolRel}\big)(R) &= \Big(\bigcup_{n\geq 1}(R\cup R^\transp \cup \id_A)^n\Big) \cup \Big(\bigcup_{n\geq 1}(R\cup R^\transp \cup \id_A)^n\Big)^\transp \cup \id_A \\
&= \Big(\bigcup_{n\geq 1}(R\cup R^\transp \cup \id_A)^n\Big) \cup \Big(\bigcup_{n\geq 1}(R\cup R^\transp \cup \id_A)^n\Big) \cup \id_A \\
&= \Big(\bigcup_{n\geq 1}(R\cup R^\transp \cup \id_A)^n\Big) \cup \id_A \\
&= \bigcup_{n\geq 1}(R\cup R^\transp \cup \id_A)^n  \cup \id_A \\
&= \bigcup_{n\geq 1}(R\cup R^\transp \cup \id_A)^n \\
&= \big(\Closure_{\TransRel}\circ \Closure_{\TolRel}\big)(R).
\end{align*}
\end{proof}
