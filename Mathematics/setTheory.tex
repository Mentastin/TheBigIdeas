...
\begin{lemma} \label{monotonicityImage}
Let $R$ be a relation on $(A, B)$ and $X,Y\subset A$. Then
\begin{enumerate}
\item if $X\subseteq Y$, then $XR \subseteq YR$;
\item if $X\subseteq Y$, then $RX \subseteq RY$.
\end{enumerate}
\end{lemma}

\begin{lemma} \label{imageRelation}
Let $R$ be a relation on $(A, B)$ and $X,Y\subset A$. Then
\begin{itemize}
...
\end{itemize}
\end{lemma}
\begin{lemma} \label{preimageRelation}
...
Let $f:A\to B$ be a function and $X,Y\subseteq B$. Then by the general theory of relations (\ref{preimageRelation})
\begin{itemize}
...
\begin{lemma} \label{preimageProperties}
...
Let $f:A\to B$ be a function and $X,Y\subseteq A$. Then by the general theory of relations (\ref{imageRelation})
\begin{itemize}
...
\section{A calculus of relations}
\begin{proposition}
\begin{itemize}
...
Relation completely determined by images of singletons.
...
\end{proof}
TODO: general relations! + link inclusions with totality and uniqueness (also injectivity and sujectivity)

TODO: $\upset q = q\leq$ and $\downset q = \leq q$.

\subsection{Relational structures}
\subsubsection{Functions on relational structures}
...
\subsubsection{Relation isomorphisms}
\begin{definition}
...
\subsection{Identical domain and codomain}
...
\begin{lemma} \label{fixedPointsMultipleComposition}
...
\chapter{Indexing and indexed sets}
\begin{definition}
...
\section{Union and intersection of indexed families of sets}
...
\subsection{Union and intersection of index sets}
...
\section{Arbitrary Cartesian products}
\begin{definition}
...
\subsection{Distributing over unions and intersections}
\begin{lemma}
