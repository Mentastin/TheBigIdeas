...
\subsubsection{Tops and bottoms}
\begin{definition}
Let $R$ be a relation on $(A,B)$. Let $X\subseteq A$ and $Y\subseteq B$ be sets.
\begin{itemize}
\item The \udef{$R$-top} (or just \udef{top}) of $X$ is $X^R \cap X$.
\item The \udef{$R$-bottom} (or just \udef{bottom}) of $Y$ is $^RY \cap Y$.
\end{itemize}
\end{definition}
