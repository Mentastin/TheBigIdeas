...
\begin{enumerate}
\item $Q \subseteq \;\downarrow Q$;
\item $Q \subseteq \;\uparrow Q$.
\end{enumerate}
\end{lemma}
\begin{proof}
Reflexivity.
...
Let $P$ be a proset and $Q\subseteq P$, then
\begin{enumerate}
\item $Q$ is a down-set \textup{if and only if} $Q = \;\downarrow Q$ \textup{if and only if} $Q \supseteq \;\downarrow Q$;
\item $Q$ is an up-set \textup{if and only if} $Q = \;\uparrow Q$ \textup{if and only if} $Q \supseteq \;\uparrow Q$.
\end{enumerate}
\end{corollary}
\begin{proof}
The equivalence of $Q = \;\downarrow Q$ and $Q \supseteq \;\downarrow Q$ is given by \ref{lemma:QsubseteDownQ}.

We just need to show that $Q$ is a down-set iff $Q \supseteq \;\downarrow Q$. By the lemma both these statements are equivalent to
\[ \forall y\in P: y\in \;\downarrow Q \implies y\in Q. \]
\end{proof}

\begin{lemma}
Let $P$ be a proset and $Q\subseteq P$. Then
\begin{enumerate}
\item $\downarrow Q = \bigcup_{x\in Q}\downarrow x$;
\item $\uparrow Q = \bigcup_{x\in Q}\uparrow x$.
\end{enumerate}
\end{lemma}

\begin{lemma}
Let $P$ be a proset and $Q,R\subseteq P$. Then
\[ \downarrow Q \subseteq \;\downarrow R \iff Q \subseteq R \iff \uparrow Q \subseteq \;\uparrow R. \]
\end{lemma}

\begin{lemma}
Let $P$ be a proset. Then $\downarrow\emptyset = \emptyset = \;\uparrow\emptyset$.
\end{lemma}
...
\begin{itemize}
\item A \udef{greatest element}, \udef{largest element} or \udef{maximum} of $S$ is an element $x\in S$ that is greater than or equal to every other element in $S$: $\forall y\in S: y\precsim x$.
...
\begin{itemize}
\item A \udef{least element}, \udef{smallest element} or \udef{minimum} of $S$ is an element $x\in S$ that is smaller than or equal to every other element in $S$: $\forall y\in S: x\precsim y$.
...
\item a \udef{lattice} if each finite non-empty subset has a supremum and an infimum;
