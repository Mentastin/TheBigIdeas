...
\begin{lemma}
Let $A,B$ be classes and either $A$ or $B$ is a set. Then the intersection $A \cap B$ is a set.
\end{lemma}
\begin{proof}
This follows from the axiom of separation and the fact that $A \cap B$ is a subclass of both $A$ and $B$.
\end{proof}
...
\item \textbf{Union set axiom}: Let $A, B$ be sets. Then $A \cup B$ is a set.
\end{enumerate}
...
\begin{lemma}
Let $a,b, c \ldots$ be elements. Then
\begin{enumerate}
\item $a \in \{a,b, c \ldots\}$;
\item $\{a,b, c \ldots\}$ is a set.
\end{enumerate}
\end{lemma}
\begin{proof}
(1) By the axiom of class existence.

(2) By definition we can find sets $A,B,C \ldots$ such that $a\in A, b\in B, c\in C \ldots$ Then $\{a,b, c \ldots\} \subseteq A\cup B\cup C \cup \ldots$ and thus a set by the union set axiom and the axiom of separation.
\end{proof}
