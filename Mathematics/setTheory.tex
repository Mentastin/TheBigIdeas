...
Let $A$ be a class, $f: A\times A \to A$ an associative binary function and $x, y\in A$ such that $x\greensD y$. Then there exist $a,b,c,d\in \widetilde{A}$ such that
...
\end{proof}
\begin{corollary}
Let $A$ be a class, $f: A\times A \to A$ an associative binary function and $x\in A$. If $x$ is an idempotent, then
...
Let $f$ be an associative binary function on $A$ and $H$ an $\mathcal{H}$-class in $A$. Then either
\begin{enumerate}
\item $H^2\perp H$; or
...
Let $f$ be an associative binary function on $A$ and $H$ an $\mathcal{H}$-class in $A$.Then
\begin{enumerate}
...
\begin{proposition} 
Let $A$ be a class and $f: A\times A \to A$ a binary associative function. If $x\in A$ is regular, then every element in $[x]_{\greensD}$ is regular.
\end{proposition}
