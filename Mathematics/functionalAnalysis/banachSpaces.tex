...
\end{corollary}
\begin{proof}
This follows from \ref{HausdorffContinuousLatticeOperationsOrderCompatible}.
\end{proof}
...
Since pointwise convergence is often strictly weaker than norm convergence, we clearly have $\uniformity_{\mathfrak{o}} \nsubseteq \uniformity_{\norm{\cdot}}$.
...
We first show that $x$ is an upper bound of $\{x_i\}_{i\in I}$ 
\end{proof}
