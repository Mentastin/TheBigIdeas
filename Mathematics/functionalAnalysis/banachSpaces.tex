...
We then calculate
\begin{align*}
R_x(\lambda) - R_x(\mu) &= R_x(\lambda)R_x(\mu)(\mu - x) - R_x(\mu)R_x(\lambda)(\lambda - x) \\
&= \mu R_x(\lambda)R_x(\mu) - \cancel{R_x(\lambda)R_x(\mu) x} - \lambda R_x(\mu)R_x(\lambda) + \cancel{R_x(\mu)R_x(\lambda) x} \\
