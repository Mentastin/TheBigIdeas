...
\begin{enumerate}
\item $f$ is positively homogenous (i.e.\ $f(tv) = tf(v)$ for all $v\in V$ and $t\geq 0$);
...
\begin{proposition}
Let $V$ be a vector space and $A,B\subseteq V$ absolutely convex and absorbent subsets.
\begin{enumerate}
