...
\begin{definition}
Let $X$ be a set. A \udef{filtration} on $X$ is a family of subsets $\seq{X_i}_i=0^\infty$ such that $X_i \subseteq X_{i+1}$ and $X = \bigcup_{i=0}^\infty X_i$.
\end{definition}

\subsection{Grade operator}
\begin{definition}
