...
\begin{definition}
Let $\vec{v}\in V$ be a vector. Then map $T_{\vec{v}}: V\to V: \vec{x}\mapsto \vec{x}+ \vec{v}$ is called the \udef{translation} by $\vec{v}$.
\end{definition}
...
\begin{definition}
Let $\vec{v}\in V$ be a vector and $k\in \R$. The \udef{homothety} with \udef{centre} $\vec{v}$ and \udef{ratio} $k$ is the function
