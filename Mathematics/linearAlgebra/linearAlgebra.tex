...
\section{Complexification of Riesz spaces}
\subsection{The modulus}
\begin{definition}
Let $V$ be a Riesz space and $V+iV$ its complexification. For all $z\in V+iV$, we define the \udef{modulus}
\[ |z| \defeq \sup_{\theta\in S^1} \Re(ze^{-i\theta}), \]
if this supremum exists.

If $|z|$ exists for all $z\in V+iV$, we call $V+iV$ a \udef{complex Riesz space}.
\end{definition}
