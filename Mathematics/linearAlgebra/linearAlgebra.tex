...
Convex hull: TODO Galois connections!
...
\begin{definition}
A subset $B$ of a real or complex vector space $V$ is called \udef{balanced} if for all real $|r|\leq 1$, $rC \subseteq C$.
\end{definition}

TODO cobal, not balco.

\subsubsection{Absolutely convex hull}
Convex hull, except $0\leq |r| \leq 1$.
