...
\item The dual closure of a set $X\subseteq V$ into the lattice of balanced sets is called the \udef{balanced core} of $X$ and is denoted $\semibalancedCore(X)$.
\end{itemize}
\end{definition}
...
implies \Big( w \precsim v \implies x\precsim y\Big). \]
\end{lemma}
\begin{proof}
