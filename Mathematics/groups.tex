...
If a function $G\times G\to X$ is both left and right invariant, then we typically choose the left invariant factorisation $f = \widetilde{f}\circ \Delta_l$. We often write just $\Delta$ to denote $\Delta_l$.
