...
D \ar[r] & B \ar[r] & A
\end{tikzcd} \]
by \ref{walkingConesCocones}. By \ref{limitExtensionConesCocones}, $\begin{tikzcd}[column sep=small]
D \ar[r] & B & \ar[l] B\times_A C
...
A_1 \ar[r, "f"] & B & \ar[l, swap, "g"] A_2
\end{tikzcd} \]
TODO: using \ref{limitExtensionConesCocones}.
