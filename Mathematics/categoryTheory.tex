...
\begin{proposition}
Let $\cat{C}$ be an abelian category. The functions
\[ \ker: \{\text{epimorphisms in $\cat{C}$}\} \to \{\text{monomorphisms in $\cat{C}$}\} \]
and
\[ \coker: \{\text{monomorphisms in $\cat{C}$}\} \to \{\text{epimorphisms in $\cat{C}$}\} \]
