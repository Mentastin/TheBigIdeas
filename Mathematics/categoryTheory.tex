...
We construct $\coker(\ker f): B \to C'$ and $\ker\big(\coker(\ker f)\big): A'\to B$. Diagrammatically, this gives
...
We have the diagram
\[ \begin{tikzcd}
A \arrow[r, "{\ker(f)}"] & B \arrow[r, shift left, "{f}"] \arrow[r, swap, shift right, "{0}"] & C
\end{tikzcd}. \]
We can extend the diagram to
\[ \begin{tikzcd}
A \arrow[r, shift left, "{\ker(f)}"] \arrow[r, swap, shift right, "0"] & B \arrow[r, shift left, "f"] \arrow[r, swap, shift right, "0"] & C
\end{tikzcd} \]
and then reduce it to
\[ \begin{tikzcd}
A \arrow[r, shift left, "{\ker(f)}"] \arrow[r, swap, shift right, "0"] & B \arrow[r, "f"] & C
\end{tikzcd}. \]
These manipulations preserve limits.

By definition of abelian category, it is the kernel of some morphism $g: A \to B$.

Let $f: B\to C$ be an epimorphism in $\cat{C}$. By definition of abelian category, it is the cokernel of some morphism $g: A \to B$. We need to show that $g$ is the kernel of $f$. This follows because every cone of
\[ \begin{tikzcd}
A \arrow[r, shift left, "g"] \arrow[r, swap, shift right, "0"] & B \arrow[r, "f"] & C
\end{tikzcd} \]
can be uniquely extended to a cone of
\[ \begin{tikzcd}
A \arrow[r, shift left, "g"] \arrow[r, swap, shift right, "0"] & B \arrow[r, shift left, "f"] \arrow[r, swap, shift right, "0"] & C
\end{tikzcd}. \]
Thus 
\end{proof}
